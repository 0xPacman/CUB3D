...
/*   Updated: 2023/03/15 17:58:38 by ahjadani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_left(t_engine *engine)
{
	...
	engine->player.dir.x = (engine->player.dir.x
			* cos(engine->player.rot_speed))
		- (engine->player.dir.y * sin(engine->player.rot_speed));
	engine->player.dir.y = (old_dir_x
			* sin(engine->player.rot_speed))
		+ (engine->player.dir.y * cos(engine->player.rot_speed));
	engine->player.plane.x = (engine->player.plane.x
			* cos(engine->player.rot_speed))
		- engine->player.plane.y * sin(engine->player.rot_speed);
	engine->player.plane.y = old_plane_x
		* sin(engine->player.rot_speed)
